...
import com.example.days.global.oauth.dto.google.GoogleLoginUserInfoResponse
import com.example.days.global.oauth.dto.google.GoogleTokenResponse
...
class GoogleOAuth2Client(
...
) : com.example.days.global.oauth.client.OAuth2Client {

    override fun generateLoginPageUrl(): String {
        return StringBuilder(com.example.days.global.oauth.client.GoogleOAuth2Client.Companion.GOOGLE_AUTH_BASE_URL)
    ...
    override fun getAccessToken(authorizationCode: String): String {
        ...
        return restClient.post()
            .uri("${com.example.days.global.oauth.client.GoogleOAuth2Client.Companion.GOOGLE_TOKEN_BASE_URL}/token")
    ...
    override fun retrieveUserInfo(accessToken: String): GoogleLoginUserInfoResponse {
        return restClient.get()
            .uri("${com.example.days.global.oauth.client.GoogleOAuth2Client.Companion.GOOGLE_API_BASE_URL}/userinfo")
